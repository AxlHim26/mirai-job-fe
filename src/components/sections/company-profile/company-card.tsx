...
import { CompanyCardProps } from "@/types/company-profile/types";
            ...
            (_, i) => (
              ...
              >
                {techStackItem.slice(i * 3, i * 3 + 3).map((item, index) => (
                  <div className="flex flex-col items-center gap-[10px] p-[12px] rounded-[4px]" key={index}>
                    <LocalImage imageName={item.image} />
